...
#define IH_MAGIC	0x27051956	/* Image Magic Number；	uIMage的魔数	*/
 ...
 */
// 这个数据结构是uboot启动kernel使用的标准的启动数据结构，zImage头信息也是一个image_header_t，但是
// 在实际启动之前需要进行一些改造。
...
#define IMAGE_FORMAT_LEGACY	0x01	/* legacy image_header based format；uboot支持uImage方式启动内核*/
#define IMAGE_FORMAT_FIT	0x02	/* new, libfdt based format；uboot支持设备树方式启动内核*/
